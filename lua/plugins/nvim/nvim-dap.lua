return {
	{
		...
		config = function()
			local keymaps = {
				...
				{
					"<Leader>dbc",
					":lua require'dap'.set_breakpoint(vim.fn.input('Condition: '), vim.fn.input('Place on Line: '), nil)<CR>",
					desc = "Set Conditional Breakpoint @Line",
				},
				...
				{
					"<Leader>dwa",
					":lua require'dapui'.elements.watches.add(vim.fn.input('Watch Expression: '))<CR>",
					desc = "Add watch Expression",
				},
				{
					"<Leader>dwe",
					":lua require'dapui'.elements.watches.edit(tonumber(vim.fn.input('Index: ')), vim.fn.input('New Expression: '))<CR>",
				...
				{
					"<Leader>dwd",
					":lua require'dapui'.elements.watches.remove(vim.fn.input('Remove Watch @ index: '))<CR>",
